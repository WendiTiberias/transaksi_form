...
<body>
	<div class="container w-full">
			<header class="w-full bg-blue-500 py-3 text-white text-left">
				<h3 class="w-4/5 mx-auto text-2xl font-medium">Form_Laporan_Pembelian</h3>
			</header>
			<form class="">
				<div class="barang mt-10 w-4/5 mx-auto flex flex-col ">
					...
					<select id="nobeli" onchange="dateLoaded(this)" style="width:400px;" class="py-3 px-3 mx-3 border">
						<?php 
                          ...
                          include "../koneksi.php";
                          $no = mysqli_query($conn,"SELECT * FROM tbbeli");
                          $counter = 0;
					...
					<select id="suplier" style="width:400px" class="py-3 px-3 border mx-3">
						<?php 
                          ...
                          include "../koneksi.php";
                          $counter = 0;
                          $db = mysqli_query($conn  , "SELECT * FROM tbsuplier");
...
<?php } ?>
			...
			<script>
				...
				const loadItem = (e) => {
                    ...
                    const url = `loadPembelian.php?nobeli=${inner}&tgl=${dates.value}&user=${user.value}&suplier=${suplier.value}`;
